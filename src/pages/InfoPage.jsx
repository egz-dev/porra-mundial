              ...
              {error ? (
                ...
                <>
                  ...
                  <div className="info-prizes">
                    <div className="info-prize"><span className="info-medal">🥇</span><strong>1er clasificado</strong> → <span className="info-prize-eur">42 €</span></div>
                    <div className="info-prize"><span className="info-medal">🥈</span><strong>2º clasificado</strong> → <span className="info-prize-eur">21 €</span></div>
                    <div className="info-prize"><span className="info-medal">🥉</span><strong>3er clasificado</strong> → <span className="info-prize-eur">12 €</span></div>
                    <div className="info-prize"><span className="info-medal">💀</span><strong>Último</strong> (menos puntos) → <span className="info-prize-eur">5 €</span> ¡por aguantar el tirón!</div>
                    <div className="info-prize"><span className="info-medal">🟥</span><strong>Más tarjetas rojas</strong> acumuladas → <span className="info-prize-eur">5 €</span> ¡por jugar sucio!</div>
                  </div>
                </>
              )}
            </div>
