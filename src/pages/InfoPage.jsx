        ...
        <div className="container">
          <div className="info-page">
            ...
            <div className="info-card">
              ...
              <p>El diseño es sencillo y funcional, pero si alguien quiere aportar su granito de arena para mejorarlo, ¡será más que bienvenido! 🎨. Para cualquier duda, idea 💡 o bug 🐛, este es mi correo: <a href="mailto:hola@edugarcia.dev">hola@edugarcia.dev</a> 📨.</p>
            ...
            <div className="info-card">
              ...
              <ul className="info-grid">
                ...
                <li>⚽ 6 goles en un partido <span className="info-pts">+2 puntos adicionales</span></li>
              </ul>
            </div>
